...
1345679
demagog@demagog-VivoBook-ASUSLaptop-X509BA-D509BA:~/Загрузки$ ./a.out
2389745982374509823450973497582398449367390487560259867345
28974598237450982345097349758239844936739048756025986735
```
...
```
## 11. Выводы
Был изучен алгоритм написания программы на языке Си. Приобретён навык обработки целых чисел в Си с помощью комманды getchar().
